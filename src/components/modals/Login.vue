    ...
    <template v-slot:form>
      <div class="bg-white z-10 rounded-t-lg w-full max-w-xl mx-auto md:rounded-lg ">
        <div class="md:p-20">
          ...
          <div class="p-4">
            <p class="mb-6 md:-mt-6 md:mb-12 ">Don't have an account? <span class="text-red-500 cursor-pointer ">Create Account</span></p>
            <form>
...
export default defineComponent({
  ...
  setup() {
    const { $axios, $unFreezeBody, $hideModal } = useContext()
